...
extern void LocalApicInit();

extern uint32_t LocalApicGetId();
extern void LocalApicSendInit(uint32_t apic_id);
extern void LocalApicSendStartup(uint32_t apic_id, uint32_t vector);
extern void LocalApicSendIPC(uint32_t apic_id, uint32_t vector);
